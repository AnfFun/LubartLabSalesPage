...
| [03](03-services.md) | Visitors understand the three things LubartLab builds | Done |
...
Steps 00–03 are complete. Step 04 is the next permitted logical block. The
brand shell, hero, and services replace the neutral holding page while the
